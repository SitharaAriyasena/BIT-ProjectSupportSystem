...
<div class="container-fluid">
	...
	<div style="margin-top:50px;">
			...
			<div class="row">
				...
				<div class="row">
				<!-- Form directs to insertNewAnswer servelet when submitted -->
					<form action="insertNewAnswer" method="post">
						<textarea name="reply" cols="155" rows="3" id="reply" placeholder="Type your Reply..."></textarea>
						<p>*Please type your reply</p>
					 
						<button type="submit" class="btn btn-default">Submit</button>
						<a class="btn btn-default" href="ShowReply"> Reset </a>
					</form>
